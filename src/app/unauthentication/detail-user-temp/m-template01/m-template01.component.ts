...
@Component({
  selector: 'app-m-template01',
  templateUrl: './m-template01.component.html',
  styleUrls: ['./m-template01.component.scss']
})
export class MasterTemplate01Component implements OnInit {
