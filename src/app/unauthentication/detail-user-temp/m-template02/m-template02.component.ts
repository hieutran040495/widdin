...
@Component({
  selector: 'app-m-template02',
  templateUrl: './m-template02.component.html',
  styleUrls: ['./m-template02.component.scss']
})
export class MasterTemplate02Component implements OnInit {
